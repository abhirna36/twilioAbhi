...
class LaunchFlowImpl: LaunchFlow {
    ...
    func start() {
        ...
        let storyboard = UIStoryboard(name: "WHTwillio", bundle: nil)
        ...
        let segueIdentifier = authStore.isSignedIn ? "lobbySegue" : "lobbySegue"//signInSegueIdentifierFactory.makeSignInSegueIdentifier()
